							...
							<div>
								<div class="flex w-full justify-end">
									<Tooltip content="Update All Models" placement="top">
										<button
											class="p-2.5 flex gap-2 items-center bg-gray-850 hover:bg-gray-800 text-gray-100 rounded-lg transition"
											on:click={() => {
												updateModelsHandler();
											}}
										>
							...
							<div class="flex w-full">
								<div class="flex-1 mr-2 flex flex-col gap-2">
									...
									<textarea
										...
										class="w-full rounded-lg py-2 px-4 text-sm text-gray-100 bg-gray-850 outline-none resize-none scrollbar-hidden"
										rows="6"
								...
								<div class="flex self-start">
									<button
										class="px-2.5 py-2.5 bg-gray-850 hover:bg-gray-800 text-gray-100 rounded-lg transition disabled:cursor-not-allowed"
										on:click={() => {
											createModelHandler();
										}}
										disabled={createModelLoading}
							...
							>
								...
								<div class="flex w-full mb-1.5">
									<div class="flex flex-col w-full">
										{#if modelUploadMode === 'file'}
											...
											>
												...
												<button
													type="button"
													class="w-full rounded-lg text-left py-2 px-4 text-gray-300 bg-gray-850"
													on:click={() => {
										...
										{:else}
											<div class="flex-1 {modelFileUrl !== '' ? 'mr-2' : ''}">
												<input
													class="w-full rounded-lg text-left py-2 px-4 text-gray-300 bg-gray-850 outline-none {modelFileUrl !==
													''
														? 'mr-2'
														: ''}"
													type="url"
									...
									{#if (modelUploadMode === 'file' && modelInputFile && modelInputFile.length > 0) || (modelUploadMode === 'url' && modelFileUrl !== '')}
										<button
											class="px-2.5 bg-gray-850 hover:bg-gray-800 text-gray-100 rounded-lg disabled:cursor-not-allowed transition"
											type="submit"
											disabled={modelTransferring}
										>
											{#if modelTransferring}
									...
									<div>
										<div>
											...
											<textarea
												...
												class="w-full rounded-lg py-2 px-4 text-sm text-gray-100 bg-gray-850 outline-none resize-none"
												rows="6"
											/>
										</div>
									</div>
